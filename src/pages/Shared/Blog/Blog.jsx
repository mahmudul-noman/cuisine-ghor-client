    ...
    return (
        <>
            <div className='container mx-auto py-12'>
                <h4 className='mb-4 text-center text-2xl font-extrabold'>All Question & Answer You Want To Know</h4>
                <div className='grid grid-cols-2 gap-4'>
                    <div className="one shadow border-2 border-gray-300 p-8">
                        <h4 className='flex items-center gap-4 font-extrabold text-red-500 text-lg mb-4'>Tell us the differences between uncontrolled and controlled components. <FaDownload className='text-black text-xl cursor-pointer'></FaDownload> </h4>
                    ...
                    <div className="two shadow border-2 border-gray-300 p-8">
                        <h4 className='flex items-center gap-4 font-extrabold text-red-500 text-lg mb-4'>How to validate React props using PropTypes ? <FaDownload className='text-black text-xl cursor-pointer'></FaDownload> </h4>
                        <p className='text-base leading-8'>
                    ...
                    <div className="three shadow border-2 border-gray-300 p-8">
                        <h4 className='flex items-center gap-4 font-extrabold text-red-500 text-lg mb-4'>Tell us the difference between nodejs and express js. <FaDownload className='text-black text-xl cursor-pointer'></FaDownload> </h4>
                    ...
                    <div className="four shadow border-2 border-gray-300 p-8">
                        <h4 className='flex items-center gap-4 font-extrabold text-red-500 text-lg mb-4'>What is a custom hook, and why will you create a custom hook? <FaDownload className='text-black text-xl cursor-pointer'></FaDownload> </h4>
                        <p className='text-base leading-8'>
